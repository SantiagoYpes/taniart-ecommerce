...
export default function Background({ children }: ChildrenType) {
  return (
    <div className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 h-40 rotate-45 bg-fuchsia-200 opacity-95 shadow-[0_0_20px_5px_rgba(255,0,255,0.6)]" />
      {children}
      {/* Reflejo base */}
