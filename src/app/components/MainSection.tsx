...
export const MainSection = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center px-8 md:px-20 py-12 md:py-24">
      <div className={`md:w-1/2 space-y-15 transition-all duration-1000 ease-in-out transform ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"
        }`}>
      ...
      <div className={`w-[500px] h-[450px] mt-12 md:mt-0 flex justify-center shadow-[0_0_20px_2px_rgb(236,23,252)] transition-all duration-1000 ease-in-out transform ${show ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
